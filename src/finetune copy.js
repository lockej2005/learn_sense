...
// Set up OpenAI API
const openaiApi = new openai.OpenAIApi('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');
...
async function main() {
  try {
    ...
    const fileId = await uploadFile('C:/Users/fired/OneDrive/All/Documents/Repositories/learn_sense/src/api/example.json');
